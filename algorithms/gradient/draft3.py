...
if __name__ == "__main__":
    ...
    opt_lr = 0.05
    opt_lr_decay = True
    opt_sampling_type = "gibbs_sampling"
    ...
    np.save("distance/LS4/" + opt_name_store + "_dw.npy", dw_records)
    np.save("distance/LS4/" + opt_name_store + "_dvb.npy", dvb_records)
    np.save("distance/LS4/" + opt_name_store + "_dhb.npy", dhb_records)