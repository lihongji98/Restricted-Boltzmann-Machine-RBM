...
if __name__ == "__main__":
    ...
    np.save("distance/BS4/" + opt_name_store + "_dw.npy", dw_records)
    np.save("distance/BS4/" + opt_name_store + "_dvb.npy", dvb_records)
    np.save("distance/BS4/" + opt_name_store + "_dhb.npy", dhb_records)